...
- **기본 익명성 + Orb Mode**: 일반 사용자에겐 익명, Orb Mode 구독자는 "누가 나를 선택했는지" 확인 가능
...
| 익명성 악용 | 기본 익명이지만 voter_id 저장 (Orb Mode용). Circle 단위 제재 + Orb Mode 수익화로 건전성 유지 |
...
|------|-----|-----|
| 보상 | Flames | Gems |
| 수익화 | Orb Mode 구독 (누가 나를 선택했는지 공개) | 인앱 동기 부여 |
