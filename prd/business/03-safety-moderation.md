...
#### 긍정적 질문 강화
- 전체 템플릿의 100%를 선택받은 사람이 기분 좋아지는 긍정형 질문으로 구성
- 외모/분위기/호감/크러시 질문은 Circly의 핵심 카테고리로 허용한다.
- 단, "못생긴 사람은?", "연애 못할 것 같은 사람은?"처럼 비하, 조롱, 배제, 부정 비교, 상처 가능성이 있는 질문은 금지한다.
- 허용 예시는 "잘생긴 사람은?", "우리 Circle 대표 고양이상은?", "분위기가 제일 좋은 사람은?", "보면 설레는 사람은?"처럼 칭찬형으로 제한한다.
